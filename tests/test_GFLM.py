...
class TestGFLM(TestCase):
    ...
    def test_small_results(self):
        ...
        expected_gflm_word_all = pd.DataFrame([[0.16, 0, 0], [.81, 1, 0], [.81, 0, 1], [.49, 1, 1]], columns=["gflm_word", "section_id", "implicit_feature_id"])
        expected_gflm_word = pd.DataFrame([[.81, 1, 0], [.81, 0, 1], [.49, 1, 1]], columns=["gflm_word", "section_id", "implicit_feature_id"])
