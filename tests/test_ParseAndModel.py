...
class TestParseAndModel(TestCase):
    ...
    def test_bem_one_section(self):
        ...
        self.assertEqual(True, np.array_equiv(expected_section_word_counts_matrix, csr_matrix.toarray(em_input["section_word_counts_matrix"])))
        self.assertEqual(True, np.array_equiv(expected_model_background_matrix,csr_matrix.toarray(em_input["model_background_matrix"])))
        self.assertEqual(True, np.array_equiv(expected_model_feature_matrix, csr_matrix.toarray(em_input["model_feature_matrix"])))
    ...
    def test_bem_two_section(self):
        ...
        self.assertEqual(True,
                         np.array_equiv(expected_section_word_counts_matrix, csr_matrix.toarray(em_input["section_word_counts_matrix"])))
        self.assertEqual(True, np.array_equiv(expected_model_background_matrix, csr_matrix.toarray(em_input["model_background_matrix"])))
        self.assertEqual(True, np.array_equiv(expected_model_feature_matrix, np.round(csr_matrix.toarray(em_input["model_feature_matrix"]),3)))
        self.assertEqual(True, expected_vocab_lookup == em_input["vocabulary_lookup"])
